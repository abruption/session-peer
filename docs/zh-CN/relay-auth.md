...
的提供商运维人员授权。
Authelia 门户可以查询用户、公开注册、设备和操作的受限明细列表。列表可包含
姓名、电子邮件、提供商、操作 ID、状态、代次和缩短的 principal。绝不包含
提供商账户 ID、内部用户 ID、完整 principal、令牌、Cookie、proof、请求 hash、
证书或密钥，并且每个响应最多返回 100 行。
