...
official skill for Claude Code and Codex with the open agent skills CLI:
...
The verified command writes the skill to both
`~/.claude/skills/session-peer/SKILL.md` and
`~/.agents/skills/session-peer/SKILL.md`. Skill updates remain explicit and
