    ...
    def test_sdist_contains_exact_source_and_documentation_contract(self):
        expected = {
            ...
            *self.source_files("session_peer_relay"),
            ...
            "docs/mcp.md",
            "docs/wake.md",
            "docs/multi-home-list.md",
            "docs/agent-adapters.md",
            "docs/paired-devices.md",
            "docs/relay-development-plan.md",
            "docs/relay-public-pilot-2026-09-17.md",
            "docs/antigravity.md",
            "docs/validation/85-antigravity.md",
            "docs/architecture/agent-transports.md",
            "deploy/session-peer-relay.service",
