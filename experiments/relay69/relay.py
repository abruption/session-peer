...
class Relay:
    ...
    async def process_request(self, connection, request):
        ...
        if request.path == '/v1/session':
            ...
            response.headers['Set-Cookie'] = 'relay69='+token+'; Path=/v1/; Secure; HttpOnly; SameSite=Strict; Max-Age=120'
            return response
        ...
        try:
            ...
            ticket = self.sessions.get(cookie['relay69'].value)
    ...
    async def handler(self, ws):
        ...
        try:
            ...
            try:
                await asyncio.wait({ready, closed}, timeout=10, return_when=asyncio.FIRST_COMPLETED)
