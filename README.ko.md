...
[![PyPI 월간 다운로드](https://img.shields.io/pypi/dm/session-peer?label=PyPI%20downloads%2Fmonth&cacheSeconds=86400)](https://pypistats.org/packages/session-peer)
...
[다운로드 지표](https://github.com/abruption/session-peer/blob/main/docs/download-metrics.md)는 사용자 수가 아니며 CI·반복 다운로드가 포함될 수 있어요.
